                    ...
                    <div className="container ">
                        <div className="row justify-content-center">
                            <div className="col-md-3 colBorder">
                                ...
                                <h2>Sculptor Christian Lapie:
            Beauty from Charred Ashes</h2>
                            ...
                            <div className="col-md-3 colBorder">
                                ...
                                <h2>Artist Humberto Castro:
            Master of Transformation</h2>
                            ...
                            <div className="col-md-3 colBorder">
                                ...
                                <h2>Zammy Migdal: Creator
            of Wall Sculpture</h2>
