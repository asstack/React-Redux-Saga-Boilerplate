                    ...
                    <div className="row">
                        <div className="">
                            <nav className="navbar navbar-expand-lg">
                                {/* <!-- Logo --> */}
                                <div className="leftPart"> <a href="#!" className="menuIcon"></a>
                                    <div className="breaCrumb"> <a className="navbar-brand" href="index.html">NLF</a> <span className="divider">/</span> <span className="pageName">Art Boca Raton</span> </div>
                                </div>
                                {/* <!-- Navbar Toggler --> */}
